...
export const BLOG_POSTS = [
  {
    ...
    body: [
      ...
      'A boa notícia é que preparar a mochila certa é simples. Na edição de 2025 em Timbó, quem chegou com o básico resolvido ganhou tempo onde importava: na construção do produto.',
      '## O essencial',
      ...
      'Fones de ouvido — sábado de manhã, 9h, o salão da CETISA está cheio de gente discutindo ao mesmo tempo. Ter fones ajuda a isolar quando você precisa escrever, prototipar ou simplesmente pensar por 15 minutos.',
      ...
      'Slides prontos — na sexta à noite, ninguém sabe qual ideia vai vencer a votação. O pitch de domingo nasce do que o time construiu no sábado. Chegar com material pronto não só é inútil como pode te travar numa direção que o time não vai seguir.',
  ...
  },
  {
    ...
    body: [
      'Sexta-feira, 19h30, CETISA. Quarenta e poucos desconhecidos sentados em cadeiras de plástico, alguns nervosos, outros curiosos. A maioria não se conhece. A maioria não trouxe ideia nenhuma. E é exatamente assim que funciona.',
      ...
      'Larissa trabalha com design gráfico em Blumenau. Não tinha interesse em empreender. Uma colega insistiu tanto que ela foi "só para ver". Sexta à noite, 21h, ela estava colando post-its num cartaz com o nome da ideia que tinha acabado de votar.',
      ...
      'Ele entrou num time que estava construindo uma solução de gestão de escalas para pequenos comércios. Sábado, 16h, ele estava no telefone ligando para donos de padaria da região perguntando se pagariam R$49 por mês pelo app. Duas horas depois já tinha 3 pré-vendas.',
  ...
  },
  {
    ...
    body: [
      'Sexta-feira, 20h15. O facilitador pede que quem tiver uma ideia levante a mão. Silêncio. Depois uma mão. Depois três. Depois doze. Cada um vai até a frente, pega o microfone e tem 60 segundos. O cronômetro na tela é implacável.',
      ...
      'Primeiro, o problema — descrito de forma que as pessoas na plateia reconheçam. Na edição de 2025, um participante começou com: "ontem eu passei 40 minutos procurando um fisioterapeuta em Timbó e desisti." Metade da sala acenou com a cabeça. Ele ganhou 14 votos.',
  ...
  },
  {
    ...
    body: [
      ...
      'A segunda edi\u00e7\u00e3o do Startup Weekend Timb\u00f3 acontece de 14 a 16 de agosto de 2026, na CETISA. Inscri\u00e7\u00f5es pelo Sympla.',
    ],
  },
];
...
export const SPONSORS: Record<'global'|'estadual'|'local', { name: string; logo: string; dark: boolean | 'warm' }[]> = {
  ...
  estadual: [
    ...
    { name: 'Senior Sistemas', logo: '/images/sponsors/senior.png', dark: 'warm' },
